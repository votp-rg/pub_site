...
- Increases hazardous chemical throughput,
- Introduces expanded solvent handling and waste streams.

Yet the Draft EIA **does not critically re-examine the legitimacy or consequences of the original B2 clearance**, nor does it acknowledge that:

- The affected population was **systematically excluded** from the initial decision,
- The current proposal represents a **qualitative escalation of risk**, not a routine expansion.
...
Facts omitted or obscured:

- The proponent operates a **formulation unit at Haridwar**, which involves blending and packaging.
- Bulk drug synthesis involves **hazardous reactions, solvent recovery, toxic gas generation, and accident-prone batch operations**, which are categorically different.
...
- Methanol, IPA, toluene, acetone, dichloromethane (DCM), etc., have **radically different toxicological profiles**,
- Some are neurotoxic, some carcinogenic, some acutely irritating.
...
- **Given fugitive solvent losses of approximately 652 kg/day**.

However, the report:

- Does not calculate workplace air concentrations,
- Does not estimate off-site ambient concentrations,
- Does not assess chronic exposure for workers or nearby residents.
...
“Scrubber/condenser provided → therefore no emission.”

This is **fundamentally unscientific**.

Established chemical-engineering facts:

- No scrubber or condenser operates at 100% efficiency,
- Start-up, shutdown, batch peaks, and upset conditions guarantee residual emissions,
- Fugitive emissions are, by definition, uncontrolled.
...
- Toxic gas release scenarios and impact distances,
- Explosion over-pressure contours,
- Thermal radiation zones from fires,
- Mapping of nearby habitations against hazard contours.

This is particularly grave because:

- Nearest habitations are acknowledged to be approximately **1.14 km away**,
- Bulk drug units are internationally recognised as accident-prone.
...
- Does not analyse worst-case scenarios,
- Does not assess night-time exposure,
...
- Does not analyse failure modes of MEE, RO, or solvent stripping,
- Does not assess cumulative groundwater stress,
- Does not consider secondary air emissions from effluent treatment and evaporation.
...
- **Aggregation instead of specification**,
- **Control devices instead of quantified residuals**,
- **Assertions instead of calculations**,
- **Lists instead of models**,
- **Acknowledgement of facts without consequence analysis**.
...
- The EIA fails to characterise real risks,
- It denies decision-makers the information needed for precaution,
- It undermines public health protection,
- It violates the spirit of the EIA Notification, 2006.

**This Draft EIA should therefore be:**

1.  **Rejected in its present form**, and
2.  Returned with directions for:
    - Full pollutant-specific emission quantification,
    - Proper QRA with mapped impact distances,
    - Transparent assessment of fugitive emissions,
    - Explicit evaluation of odour and sulphur gas risks,
    - Independent verification of operational competence.

Until these are done, **any appraisal would be scientifically unsound and procedurally unsafe**.